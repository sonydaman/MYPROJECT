...
router.get('/', function(req, res, next) {
  response.requestPage.revokePage(res,constant.rok,'respond with a resource');
});
// ALL USERS INFORMATION
router.get(constant.usersUrl, function(req, res) {
	...
	response.mongoDB.fetchData(collection,{},{},function(result){        
		console.log(result)
		 response.requestPage.renderPage(res,constant.usersView,constant.rok, {"userlist" : result.data}); 
    });
